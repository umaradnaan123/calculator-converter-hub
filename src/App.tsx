        ...
        <div style={{ padding: '32px', display: 'flex', flexDirection: 'column', gap: '32px', flex: 1 }}>
          {activeTool ? (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '44px' }} className="animate-fade-in">
              ...
              {/* Featured Direct Portals */}
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }} className="animate-fade-in">
                <h3 style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '1.2rem', fontWeight: '700' }}>
                  <Icons.ExternalLink size={18} className="text-gradient" /> Featured Direct Portals
                </h3>
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '16px' }}>
                  <a
                    ...
                    style={{
                      ...
                      border: '1px solid rgba(var(--accent-glow-rgb), 0.15)',
                    }}
                  >
                    <div style={{ color: 'var(--accent-primary)', background: 'rgba(99, 102, 241, 0.1)', padding: '10px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                      <Icons.Globe size={24} />
                    </div>
                    <div>
                      <h4 style={{ color: 'var(--text-primary)', marginBottom: '4px' }}>CPM Network 1</h4>
                      <span style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>Open Link Portal Alpha</span>
                    </div>
                  </a>
                  ...
                  >
                    <div style={{ color: 'var(--accent-secondary)', background: 'rgba(6, 182, 212, 0.1)', padding: '10px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                      <Icons.Cpu size={24} />
                    </div>
                    <div>
                      <h4 style={{ color: 'var(--text-primary)', marginBottom: '4px' }}>CPM Network 2</h4>
                      <span style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>Open Link Portal Beta</span>
                    </div>
                  </a>
                  ...
                  >
                    <div style={{ color: 'var(--accent-tertiary)', background: 'rgba(217, 70, 239, 0.1)', padding: '10px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                      <Icons.Zap size={24} />
                    </div>
                    <div>
                      <h4 style={{ color: 'var(--text-primary)', marginBottom: '4px' }}>CPM Network 3</h4>
                      <span style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>Open Link Portal Gamma</span>
                    </div>
                  </a>
                </div>
              </div>
